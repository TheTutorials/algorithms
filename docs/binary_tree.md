...
<img src="../images/tree_travelsal.png" width = "300" >
...
<img src="../images/convert_tree_to_binary_tree.PNG" width = "300">
...
<img src="../images/convert_binary_tree_to_tree.PNG" width = "300">

#### 森林转化成二叉树
* 把每棵树转换为二叉树

    <img src="../images/convert_forest_to_binary_tree.PNG" width = "300">
* 第一棵树不动，从第二棵开始，将后一棵二叉树的根结点作为前一棵二叉树的根结点的右孩子

    <img src="../images/convert_forest_to_binary_tree_02.PNG" width = "300">

#### 二叉树还原成森林
* 从根节点将与右孩子结点的连线删除。以此类推，直到所有根结点与右孩子的连线都删除为止
* 将每棵分离后的二叉树转换为树
